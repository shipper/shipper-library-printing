...
//		sValue[3] = Convert.ToSByte('t');
    ...
    //by Eduardo Serrano
    public Image DrawBarcodeImage(int scale_x, int scale_y)
    {
        Bitmap bmp;
        sbyte[] out_Renamed;
        int cols;
        ...
        cols = (this.BitColumns - 1) / 8 + 1;
        bmp = new Bitmap(this.BitColumns * scale_x, (this.outBits.Length / cols) * scale_y);
